    ...
    if (line === 2) {
      return (
        ...
        >
          ...
          <Col span={5}>{renderInput(type, value, name)}</Col>
          <Col span={7}>
            <p className="input__name" style={{ marginLeft: "50px" }}>
              {label2}
              {required && <span className="require-text">*</span>}
            </p>
          </Col>
          <Col span={5}>{renderInput(type, value2, name2)}</Col>
        </div>
      );
    } else {
      return (
        <div className="input" {...rest}>
          ...
          <Col span={17}>{renderInput(type, value, name)}</Col>
        </div>
      );
    }
  }
